...
namespace GlowingNews.Client.Extensions
{
    public class ProgressiveStreamContent : StreamContent
    {
        ...
        public ProgressiveStreamContent(Stream stream, int maxBuffer, Action<UploadPercentageDto> onProgress) : base(stream)
        {
            _fileStream = stream;
        ...
        /// </summary>
        public event Action<UploadPercentageDto> OnProgress;
        ...
        protected override async Task SerializeToStreamAsync(Stream stream, TransportContext? context)
        {
            ...
            while (true)
            {
                ...
                OnProgress?.Invoke(new UploadPercentageDto()
                {
